...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LeadDesk Mini" },
      { name: "description", content: "Lead capture for modern teams." },
      { name: "author", content: "Digital Heroes" },
      { property: "og:title", content: "LeadDesk Mini" },
      { property: "og:description", content: "Lead capture for modern teams." },
